    ...
    return (
        <div className={styles.oneshotContainer}>
            <div className={styles.oneshotTopSection}>
                ...
                <h1 className={styles.oneshotTitle}>Ask the Partner Crucible</h1>
                <div className={styles.oneshotQuestionInput}>
                    <QuestionInput
                        placeholder="Example: What is the learning journey for a security architect?"
                        disabled={isLoading}
            ...
            <div className={styles.oneshotBottomSection}>
                ...
                {error ? (
                    <div className={styles.oneshotAnswerContainer}>
                        <AnswerError error={'There was an error processing oneshot'} onRetry={() => makeApiRequest(lastQuestionRef.current)} />
                    </div>
                ) : null}
